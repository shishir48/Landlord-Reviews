...
- [ ] **Step 1: Create `backend/tests/setup.js`** — shared DB helper (not a test file)
...
- [ ] **Step 2: Create `backend/tests/auth.test.js`** (minimal — verifies test infra works)
...
- [ ] **Step 3: Create `backend/src/config/firebase.js`**
...
- [ ] **Step 5: Mount route in `backend/src/app.js`**
...
- [ ] **Step 3: Create `backend/src/utils/levenshtein.js`**
...
- [ ] **Step 4: Create `backend/src/utils/normalizeAddress.js`**
...
- [ ] **Step 3: Create `backend/src/models/Property.js`**
...
- [ ] **Step 4: Create `backend/src/routes/properties.js`**
...
- [ ] **Step 3: Create `backend/src/models/Landlord.js`**
...
- [ ] **Step 4: Create `backend/src/routes/landlords.js`**
...
- [ ] **Step 5: Add landlord route to `backend/src/app.js`**
...
- [ ] **Step 3: Create `backend/src/models/Review.js`**
...
- [ ] **Step 4: Create `backend/src/routes/reviews.js`**
...
- [ ] **Step 5: Add review route to `backend/src/app.js`**
...
- [ ] **Step 3: Create `backend/src/middleware/adminOnly.js`**
...
- [ ] **Step 4: Create `backend/src/routes/admin.js`**
...
- [ ] **Step 5: Add admin route to `backend/src/app.js`**
